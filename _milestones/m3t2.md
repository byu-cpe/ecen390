...
to verify correct operation. In a later milestones, you will be guided
...
global boolean flag for tracking when the timer is active. Set the value
as needed inside of the LED timer component.
